...
const techStack = [
    ...
    { name: 'Supabase', color: '#3ecf8e', icon: <path fill="#3ecf8e" d="M13.316,23.734c-0.507,0.638-1.541,0.283-1.544-0.535l-0.049-11.906h9.312c1.683,0,2.62,1.944,1.573,3.264 L13.316,23.734z M10.684,0.266c0.507-0.638,1.541-0.283,1.544,0.535l0.049,11.906H2.965c-1.683,0-2.62-1.944-1.573-3.264 L10.684,0.266z" /> },
];
